...
export async function scanImage(
  ...
  switch (provider) {
    case "claude":
      return callClaude(apiKey, imageBase64, mimeType);
    case "gemini":
      return callGemini(apiKey, imageBase64, mimeType);
    case "googleVision":
      return callGoogleVision(apiKey, imageBase64);
    case "clarifai":
      return callClarifai(apiKey, imageBase64);
    default:
